...
const testrun = {
  store_core: async function(opts) {
    ...
    var foo0p = seneca.entity('test/foo').make$({
      m:m0,s:'s0',i:0,b:true,o:{x:1,y:null},a:[2,null],
  ...
  store_save: async function(opts) {
    ...
    var m0 = (Math.random()+'').substring(2)
    var foo0 = await seneca.entity('test/foo').make$({
      m:m0,
      s1:null,
      s2:undefined,
      b: true
    ...
    var m1 = (Math.random()+'').substring(2)
    var foo1 = await seneca.entity('test/foo').make$({
      m:m1,
      s1:'s1~'+m1,
      s2:'s2~'+m1,
    }).save$()
    ...
    var d1 = new Date()
    var foo2 = await seneca.entity('test/foo').make$({
      m:m2,
      s1:'',
      d1: d1
    }).save$()
